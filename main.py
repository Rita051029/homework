...
class Number(Number1):
    ...
    def _printer(self, number12, number13):
        self.__number12 = number12
        self.__number13 = number13
        print(min(self.__number12,self.__number13))
        print(max(self.__number12, self.__number13))
        print(f"{min(self.__number12,self.__number13)} < {max(self.__number12,self.__number13)}")


number = Number(3, 4)
number._printer(12, 13)
#number2 = Number1(4, 2)
